...
from models import User, Vet  # Assuming User model is in models/user.py and it import in the __init__.py to make available in the package
...
class VetRegistrationForm(FlaskForm):
    ...
    state = StringField('State', validators=[DataRequired(), Length(min=4, max=30)], render_kw={"placeholder": "Enter your state"})
